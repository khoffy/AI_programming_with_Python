...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        if results_dic[key][2] == 1:
            n_pet_dog += 1
        # # match (if dog then breed matche)
        # if results_dic[key][2] == 1:
    ...
    if n_images > 0:
        pct_correct_notdogs = ((n_images - n_pet_dog) / n_images)

    results_stats_dic["n_images"] = n_images
    results_stats_dic["n_dogs_img"] = n_pet_dog
    results_stats_dic["n_notdogs_img"] = n_images - n_pet_dog
    results_stats_dic["n_correct_dog"] = n_pet_dog
    results_stats_dic["n_correct_breed"] = n_class_cdog
